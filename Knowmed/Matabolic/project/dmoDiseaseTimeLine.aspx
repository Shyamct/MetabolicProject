...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <div class="widget-box">
                        <div class="widget-title">
                           <%-- <div class="span2">
                            ...
                            <input id="btnKIT" type="button" class="btn btn-primary" onclick="myReport()" value="Show KIT" style="margin-left: 1%;" />
     ...
     <div class="modal bd-example-modal-lg" id="showTestModel" role="dialog" >
        <div class="modal-dialog modal-xl ">
            ...
            <div class="modal-content ">
                ...
                <thead >
                    <tr>
                         <td class="tdSR">Sr. No.</td> 
                         <td id="tdtest">Test Name</td> 
                    </tr>
  ...
  <table class="table table-bordered table-responsive" id="tblReport">
    ...
    <script src="customjs/dmoDiseaseTimeline.js"></script>
     <script>
