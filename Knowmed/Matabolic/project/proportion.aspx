...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  ...
  <div id="sidebar">
        <ul>
            ...
            <li style="margin-bottom: 7px;">
                <div class="input-append">
                    ...
                    <%--<span class="add-on" onclick="getPathwayWithPID()" style="background-color: #FA9600; cursor: pointer; padding: 2px 5px 0px;">Show</span>--%>
                    <span class="add-on" onclick="getNutrientInteck()" style="background-color: #FA9600; cursor: pointer; padding: 2px 5px 0px;">Show Nutrient</span>
                    <span class="add-on" onclick="givenDietOnPID()" style="background-color: #FA9600; cursor: pointer; padding: 2px 5px 0px;">Show Drug</span>
          ...
          <%--  <li style="margin-bottom: 7px;">
             ...
             <div id="divPhenomenon" style="margin-bottom: 7px;" >
                <select id="ddlphenomenon" >
                    <option value="" selected>Select Phenomenon</option>
                </select>
            </div>
              <div style="margin-bottom: 7px;">
               <button type="button" onClick="changePhenomenon()">Show</button>
            </div>
            <li style="margin-bottom: 7px;">
           ...
           <%-- <li>
            ...
            <li>
                <input type="button" class="btn btn-danger" style="width: 100%" value="Assign Symbol" onclick="getNotsigned()" />
            </li>
            <li>
                  ...
                  <%--  
                    <ul id="contextMenu" class="menu">
                        ...
                        <li id="markerType" class="menu-item">Marker Type <i class="icon-circle-arrow-right pull-right"></i>
                            <ul class="menu">
                                <li id="createCentral" class="menu-item" onclick="cxcommand(event)">Central Molecule</li>
                                <li id="createSubCentral" class="menu-item" onclick="cxcommand(event)">Sub Central Molecule</li>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table table-bordered" id="tblColorCombination">
                        <thead>
                            <tr>
                                <td class="td_CenterMolecule" style="text-align: center!important;">Central Molecule</td>
                                <td class="td_RegulatoryMolecule" style="text-align: center!important;">Sub Sub Central Molecule</td>
                                <td class="td_ReportedMolecule" style="text-align: center!important;">Sub Sub Sub Central Molecule</td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="max-height: 600px!important;">
                    <table class="table table-bordered" id="tblMarkerDetail">
                        <thead>
                            <tr>
                                <td class="td_markerName">Marker Name</td>
                                <td class="">Process Name</td>
                                <td class="td_AssociatedProblem">Meaning</td>
                                <td class="td_Meaning">Label</td>
                                ...
                                <td class="td_ErasHypotdesis">Era's Hypothesis</td>
                                 <td class="td_StudyTreatment">URL</td>
                                <td class="td_OtderPatdwayDetails">Treatment</td>
                            </tr>
                        </thead>
                        <tbody></tbody>
                    </table>
    ...
    <div class="modal" id="addInfoModel" role="dialog">
     ...
     <div class="modal fade" id="modelMolecule" style="width: 90%; left: 6%; display: none;" role="dialog">
        <div class="modal-dialog" style="width: 100rem;">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title"> Molecule List </h4>
                </div>
                <div class="modal-body">
                    <table class="table table-bordered" id="tblMolecule">
                        <tbody>
                              <select id="relationBind" class="form-control">
                             <option value="" selected>--Select Relation--</option>
                               </select>
                            <br />
                            <br />

                             <select id="moleculeBind" class="form-control">
                             <option value="" selected>--Select Molecule--</option>
                            </select>
                        </tbody>
                    </table>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-default" onclick="getMoleculeList()" data-dismiss="modal">Save</button>
                </div>
            </div>
        </div>
    </div>
       ...
       <div class="modal fade" id="modelPID" style="width: 90%; left: 6%; display: none;" role="dialog">
        <div class="modal-dialog" style="width: 100rem;">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title"> Pathway List </h4>
                </div>
                <div class="modal-body">
                    <table class="table table-bordered" id="tblPID">
                        <thead>
                            <td id="td_PathwayID" style="display:none">PathwayID</td>
                            <td id="td_Pathway" >Pathway</td>
                            <td id="td_Molecule">Molecule</td>
    ...
    <div class="modal fade" id="modeltblAboutPatient" style="width: 90%; left: 6%; display: none;" role="dialog">
        <div class="modal-dialog" style="width: 100rem;">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title"> Food Nutrient Value </h4>
                </div>
                <div class="modal-body">
                    <table class="table table-bordered" id="tblAboutPatient">
                        <thead>
                             <td>S. No</td>
                             <td>Food</td>
                            <td>Food Quantity</td>
     ...
     <div class="modal fade" id="nutrientModel" style="width: 90%; left: 6%; display: none;" role="dialog">
            <div class="modal-dialog" style="width: 100rem;">
                <!-- Modal content-->
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div class="div1" style="display:flex;">
                            <div style="background-color:#90EE90;height:20px;width:20px;"></div>  
                            <label style="margin-left:10px;margin-right:10px"> if 75 ></label>
                            <div style="background-color:#FFFFE0;height:20px;width:20px;"></div>  
                            <label style="margin-left:10px;margin-right:10px">  if 75 < and > 50</label>
                            <div style="background-color:#FF7F7F;height:20px;width:20px;"></div>  
                            <label style="margin-left:10px;margin-right:10px">  if 50 < and 1 ></label>
                            <div style="background-color:#b3b39f;height:20px;width:20px;"></div> 
                            <label style="margin-left:10px;margin-right:10px"> Not Given</label>
    ...
    <div class="modal fade" id="nutrientDATA" style="width: 90%; left: 6%; display: none;" role="dialog">
            <div class="modal-dialog" style="width: 100rem;">
                <!-- Modal content-->
                <div class="modal-content">
                    <div class="modal-header">
     ...
     <div class="modal fade" id="test" style="width: 90%; left: 6%; display: none;" role="dialog">
        <div class="modal-dialog" style="width: 100rem;">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title sb">Drug Given By Date  </h4>
                     <div class="abc">
                      <select id="ddlDate" onchange="getDrugWiseReport(this)">
          ...
          <table class="table table-bordered" id="abc" style="margin: 15px auto;">
                        <thead>
                             <td>S. No</td>
                             <td>Drug Name</td>
                            <td>Dosage Form</td>
 ...
 <script src="customjs/test4.js"></script>
