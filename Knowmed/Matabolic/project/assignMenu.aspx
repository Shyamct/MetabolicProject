...
<%--   <select id="ddlUsers">
     ...
     <div>
         ...
         <input type="button" value="SAVE" onclick="insertMenu()"/>
     </div>
    <table id="tblMenu">
        <thead>
           <tr>
               <th class="th_Sr">SR No.</th>
               <th class="th_id" style="display:none"></th>
               <th class="th_Menu"> Menu</th>
           </tr>
        </thead>
        <tbody>
  ...
  <div class="main-head" style="background-color:white;">
   <div class="row">
    <div class="assign-hd"><h3>Assign Menu Master</h3></div>
    <div class="col-sm-6">
