...
<div class="lodertop"> 
    ...
    <div id='loaderMarker' class="loder-rit" style='display:none;'>
        <img src='img/spinner.gif' style="height: 60%; width: 100%">
    </div>
    <div id="content" style="margin-left: 0px;">
                    ...
                    <div class="widget-box">
                        <div class="widget-title">
                            <div class="widget-Header">
                                ...
                                <label class="scorn-btn">Marker Scoring System</label>
        ...
        <div class="tblhed" id="GFG">
            ...
            <div class="tblhedin" style="width: 30%" id="markerTbls">
                ...
                <h3 class="tblheh3">
                    <input type="number" maxlength="10" id="txtPID" placeholder="Enter PID" class="inptnum" />
    ...
    <div class="modal bd-example-modal-lg" id="modelTestMarker" role="dialog">
        <div class="modal-dialog modal-xl" style="max-width: 1000px; margin: 30px auto; width: 80% !important;">
            ...
            <div class="modal-content ">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Test Marker </h4>
                </div>
                <div class="modal-body popup-decreption" style="color: black; overflow-y: scroll!important; height: 70vh !important;">

                    <table class="table table-bordered table-responsive" id="testMarker">
                        <thead>
                            <tr>
                                <th>Disease Name</th>
                                <th>Nutrient Name</th>
    ...
    <div class="modal bd-example-modal-lg" id="vitalScore" role="dialog">
     ...
     <div class="modal bd-example-modal-lg" id="modelToeatNotToEat" role="dialog">
        <div class="modal-dialog modal-xl" style="max-width: 1000px; margin: 30px auto; width: 80% !important;">
            <div class="modal-content ">
                <div class="modal-header">
                    <button type="button" class="close btnCloseDiet" data-dismiss="modal">&times;</button>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btnCloseDiet">Close</button>
                </div>
            </div>
        </div>
    </div>
