...
function computeMinLaneSize(lane) {
    ...
    if (HORIZONTAL) {
        if (!lane.isSubGraphExpanded) return new go.Size(1, 1);
...
function init(data, data1) {
        ...
        $(go.Node, "Auto",
            {
                ...
                click: function (e, node) {
                    ...
                    // for each Link coming out of the Node, set Link.isHighlightedinit()
            ...
            $(go.Panel, "Table",
                ...
                $(go.TextBlock, { row: 0, column: 1, font: "bold 10pt sans-serif", margin: 2 },
                    new go.Binding("text")),
            ),
        ...
        $(go.Group, HORIZONTAL ? "Horizontal" : "Vertical", groupStyle(),
            {
                ...
                //collapseSubGraph = function (group) {
            ...
            //new go.Binding("visible", "isSubGraphExpanded", function (e, grp) { groupArray.push(grp); return e; }).ofObject(),
                    ...
                    $(go.TextBlock,  // the lane label
                        {
                            ...
                            font: "bold 15pt sans-serif", editable: false, margin: new go.Margin(2, 0, 0, 0), overflow: go.TextBlock.OverflowClip /* the default value */,
            ...
            $(go.Panel, "Auto",  // the lane consisting of a background Shape and a Placeholder representing the subgraph
                ...
                $(go.TextBlock,  // this TextBlock is only seen when the swimlane is collapsed
                    {
                        name: "LABEL",
                        font: "bold 12pt sans-serif", editable: false,
    ...
    myDiagram.addDiagramListener("InitialLayoutCompleted", function (e) {
        groupArray.forEach(function (grp, i) {
            var shp = grp.resizeObject;
            if (grp.diagram.undoManager.isUndoingRedoing) return;
            if (HORIZONTAL) {
                //grp.isSubGraphExpanded = false;
        ...
        //groupArray.forEach(function (value, index) { console.log("value.resizeObject:", value.resizeObject) });
        //console.log("groupArray:", groupArray);
        //console.log("e.diagram:", e.diagram);
        //console.log("e.diagram.groupTemplate:", e.diagram.groupTemplate);
        console.log("e.diagram.findTreeRoots():", e.diagram.findTreeRoots());
        //console.log("e.diagram.findTopLevelGroups():", e.diagram.findG());
        e.diagram.findTreeRoots().each(function (r) { console.log("r:", r); r.expandTree(1); });
        //e.diagram.findTopLevelGroups().each(function (r) { console.log("r:", r); r.expandTree(1); });

    });

    //myDiagram.addDiagramListener("LayoutCompleted", function (e) {
    //    e.diagram.findTreeRoots().each(function (r) { console.log("r:", r); r.collapseTree(2); });
    //});
    ...
    myDiagram.groupTemplate.selectionAdornmentTemplate =
        $(go.Adornment, "Spot",
            ...
            $(go.Panel, "Horizontal",
                ...
                $("Button", { click: getResearchBasedQuestionModal }, $(go.TextBlock, "Research-Based-Question", { font: "bold 12pt sans-serif", textAlign: "center" })),
