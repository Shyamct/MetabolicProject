                            ...
                            $.each(interactedElementList, function (i) {
                                if (this.toEat === 'BE') {
                                    if (this.ieType === 'N') {
                                        ...
                                        if (objDock.some(d => d.nutrientID == row.nutrientID && d.interactedElementID == nutrientID1)) {
                                            ...
                                            toEatActivatorList += '<li><div style="width:100%"><span class="blink1">' + this.ieName + '</span>' + Dock + eatCount + labels + '</div><div class="foodFamilyPanel">' + foodFamilyHTMLList1 + '</div></li>';
                            ...
                            $.each(interactedElementList, function (i) {
                                if (this.toEat === 'HI') {
                                    if (this.ieType === 'N') {
                                        ...
                                        if (objDock.some(d => d.nutrientID == row.nutrientID && d.interactedElementID == nutrientID2)) {
                                            ...
                                            toEatInhibitorList += '<li><div style="width:100%"><span class="blink1">' + this.ieName + '</span>' + Dock + eatCount1 + labels + '</div><div class="foodFamilyPanel">' + foodFamilyHTMLList2 + '</div></li>';
                                        }
                                    }
                                    else if (this.ieType === 'F') {
                            ...
                            $.each(interactedElementList, function (i) {
                                if (this.toEat === 'HE') {
                                    if (this.ieType === 'N') {
                                        ...
                                        if (objDock.some(d => d.nutrientID == row.nutrientID && d.interactedElementID == nutrientID3)) {
                                            ...
                                            notToEatActivatorList += '<li><div style="width:100%"><span class="blink2">' + this.ieName + '</span>' + Dock + eatCount2 + labels + '</div><div class="foodFamilyPanel">' + foodFamilyHTMLList3 + '</div></li>';
                                        }
                                    }
                                    else if (this.ieType === 'F') {
                            ...
                            $.each(interactedElementList, function (i) {
                                if (this.toEat === 'BI') {
                                    if (this.ieType === 'N') {
                                        ...
                                        if (objDock.some(d => d.nutrientID == row.nutrientID && d.interactedElementID == nutrientID4)) {
                                            if (this.hasOwnProperty("foodFamilyList")) {
                                            ...
                                            notToEatInhibitorList += '<li><div style="width:100%"><span class="blink2">' + this.ieName + '</span>' + Dock + eatCount3 + labels + '</div><div class="foodFamilyPanel">' + foodFamilyHTMLList4 + '</div></li>';
                                        }
                                    }
                                    else if (this.ieType === 'F') {
