<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Matabolic/project/MasterPage.master"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="sidebar">
        <ul>
            ...
            <li>
                 <select id="ddlLevel" onchange="ShowLevel()" style="width: 100%;">
                     <%--<option value="0"> -- Select --</option>--%>
                     <option value="3">Level 1</option>
                    <option value="1.5">Level 2</option> 
    ...
    <script src="customjs/ProportionLevel.js"></script>
