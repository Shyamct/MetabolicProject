    ...
    Editor.init = function() {
      ...
      (function() {
        ...
        var dbox = function(type, msg, callback, defText) {
          ...
          if(type == 'prompt') {
              var input = $('<input type="text" style="width: 98%;">').appendTo($("#dialog_content"));
            input.val(defText || '');
...
$("#ModalHeader").text('Open');
            $("#modelButton").empty();
            $("#modelButton").append('<input type="button" class="btn btn-success" value="Open" onclick="window.parent.OpenSvgImage()" />');
        //svgCanvas.open();
      };
    ...
    //    updateBgImage();
      ...
      var showSourceEditor = function(e, forSaving){
        ...
        var clickSave = function () {
            var modal = document.getElementById('myModal');
            modal.style.display = "block";         
            window.localStorage.setItem("svgImage", svgCanvas.getSvgString());
            $("#modelButton").empty();
$("#ModalHeader").text('Save As');
            $("#modelButton").append('<input type="button" class="btn btn-success" value="Save" onclick="window.parent.SaveSvgImage()" />');
            //window.parent.myfunction(svgCanvas.getSvgString());
