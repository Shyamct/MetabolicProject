...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <div class="row">
    <div class="assign-hd"><h3>Assign Attribute Master</h3></div>
    <div class="col-sm-6">
        <div class="asn-menu-lt">
            <p>Assign Attribute</p>
            ...
            <div class="row1">
                ...
                <div class="col-sm-10">
                    <select class="form-control" id="ddlParent"  onchange="getChildAttributeList()">
                        <option>-- Parent Attribute --</option>
                    </select>
                </div>
            </div>
    ...
    <script src="customjs/assignAttributeMaster.js">  </script>
</asp:Content>
