...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="content" style="margin: 0">
        <div class="container-fluid" style="padding: 0;">
            <div class="row-fluid" style="margin-top: 0;">
                <div id="sample">
                    <div id="myDiagramDiv" style="height: 900px; width: 100%; border: 1px solid black"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        groupData = [{ "key": "group 1", "isGroup": true, "group": "" }, { "key": "group 2", "isGroup": true, "group": "" }, { "key": "group 3", "isGroup": true, "group": "" }];
        ...
        function randomGroup(group) {
            ...
            for (var i = 0; i < groupData.length; i++) {
                console.log(groupData[i].key);
                myDiagram.model.addNodeData({ key: groupData[i].key, isGroup: groupData[i].isGroup, group: groupData[i].group });
                addedKeys.push(groupData[i].key);
            }
