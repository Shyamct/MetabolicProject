...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <ul>
            ...
            <li style="margin-bottom: 7px;">
                <div class="input-append">
                    <input type="text" placeholder="PID" style="width: 83%;" id="PID">
                    <span class="add-on" onclick="getMedication()" style="background-color: #FA9600; cursor: pointer; padding: 2px 5px 0px;">Go</span>
          ...
          <%--  <li style="margin-bottom: 7px;">
           ...
           <%-- <li>
            ...
            <li>
                <label>
                    <input type="checkbox" onclick="showMagnifier()" />Show Magnifier</label>
            </li>
            <li>
                <button id="btnSaveJson" type="button" class="btn btn-success" style="width: 100%"">Save</button>
            </li>
           <%-- <li>
            ...
            <div class="span12">
                <div class="widget-box">
                    <div class="widget-title">
                          <input type="button" value="ZoomIn" id="btnZoomIn"/>
                          <input type="button" value="ZoomOut" id="btnZoomOut"/>
 ...
 <script src="customjs/demoNew.js"></script>
