    ...
    (function (g) {
        ...
        x(l.prototype, {
            ...
            contextMenu: function (b, a, d, c, w, m, h) {
                var e = this,
                    ...
                    B = Math.max(w, m),
                    p;
                f || (e.exportContextMenu = e[l] = f = t("div", {
                    className: b
                }, {
                        position: "absolute",
                        zIndex: 1E3,
                        padding: B + "px",
                        pointerEvents: "auto"
                    }, e.fixedDiv || e.container), p = t("div", {
                        className: "highcharts-menu"
                    }, null, f), e.styledMode || r(p, x({
            ...
            addButton: function (b) {
                var a = this,
                    d = a.renderer,
                    c = p(a.options.navigation.buttonOptions, b),
                    g = c.onclick,
                    m = c.menuItems,
                    h, e, n = c.symbolSize || 12;
                ...
                if (!1 !== c.enabled) {
                    ...
                    e = d.button(c.text, 0,
                        0, f, k, l, v).addClass(b.className).attr({
                    ...
                    c.symbol && (h = d.symbol(c.symbol, c.symbolX - n / 2, c.symbolY - n / 2, n, n, {
                        ...
                        zIndex: 1
                    }).add(e), a.styledMode || h.attr({
                        stroke: c.symbolStroke,
                        fill: c.symbolFill,
                        "stroke-width": c.symbolStrokeWidth || 1
                    }));
                    e.add(a.exportingGroup).align(x(c, {
                        width: e.width,
        ...
        l.prototype.inlineStyles = function () {
            ...
            var d = this.renderer,
                ...
                g = d.inlineBlacklist,
                l = d.inlineWhitelist,
                h = d.unstyledElements,
                e = {},
                n, k, d = z.createElement("iframe");
            r(d, {
                width: "1px",
                height: "1px",
                visibility: "hidden"
