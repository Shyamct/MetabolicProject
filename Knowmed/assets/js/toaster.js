  ...
  return {
    ...
    '<div  id="toast-container" ng-class="config.position">' +
      '<div ng-animate="\'animateToaster\'" ng-repeat="toaster in toasters">' +
        '<div class="toast" ng-class="toaster.type">' +
        '<div style="position: absolute;right: 18px;cursor: pointer;" ng-click="remove(toaster.id)">X</div>' +
        '<div ng-click="stopTimer(toaster)">'+
