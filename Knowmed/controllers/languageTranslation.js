app.controller('languageTranslationCtrl', function ($scope, dataFactory, toaster, $rootScope) {
    ...
    $scope.initControls = function () {
        dataFactory.languageTranslationInitControl().then(function (response) {
    ...
    $scope.getOriginalWord = function () {
        ...
        dataFactory.getOriginalWordList(params).then(function (response) {
            var result = response.data;
    ...
    $scope.getLanguageTranslationList = function () {
        ...
        dataFactory.getLanguageTranslationList(params).then(function (response) {
            var result = response.data;
    ...
    $scope.saveLanguageTranslation = function () {
        ...
        setTimeout(function () {
            ...
            dataFactory.saveLanguageTranslation(params).then(function (response) {
                var message = mealFoodAssignId > 0 ? 'UPDATE LANGUAGE TRANSLATION ' : 'SAVE LANGUAGE TRANSLATION ';
                $rootScope.activityLog(response, message, 'LANGUAGE TRANSLATION ', '');
    ...
    $scope.deleteLanguageTranslation = function (id) {
        if (confirm("Are you sure want to delete?")) {
            ...
            dataFactory.deleteLanguageTranslation(params).then(function (response) {
                toaster.pop('success', "Success", 'Deleted Successfully.');
                $scope.clr();
                $scope.getLanguageTranslationList();
                $rootScope.activityLog(response, 'DELETE LANGUAGE TRANSLATION', 'LANGUAGE TRANSLATION', '');
            }, function (error) {
                toaster.pop('error', "Error", error);
            });
        }
